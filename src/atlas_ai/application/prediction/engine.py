...
_WEIGHTS = {
    AgentKind.FUNDAMENTAL: 0.24,
    AgentKind.TECHNICAL: 0.15,
    AgentKind.QUANT: 0.11,
    AgentKind.MACRO: 0.09,
    AgentKind.NEWS: 0.09,
    AgentKind.BEHAVIORAL: 0.07,
    AgentKind.OPTIONS: 0.06,
    AgentKind.PORTFOLIO: 0.05,
    AgentKind.MEMORY: 0.03,
    AgentKind.RISK: 0.11,
}
